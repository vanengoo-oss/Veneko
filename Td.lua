...
Tab:Section({
    Title = "Nota: Cargue este script para iniciar la traducción antes de cargar el script que necesita traducir.",
})

Tab:Section({
    Title = "Una pequeña parte de la interfaz de usuario no se puede traducir.",
})

Tab:Toggle({
    Title = "Habilitar la traducción automática",
    Default = false,
